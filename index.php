...
include 'upper-home.php';
 ...
 <?php include 'show-filter.php'; ?>
      <!-- start show & filter product -->
    <div class="filter-product">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-2 col-md-12 show-filtre" id="myForm">
            <h5>Filtre de produit</h5>
            <hr>
            <!--
            <h6>Sélectionnez l'état</h6>
            <select id="stat" class="" name="stat">
              <option value=""></option>
              /*
          ...
          -->
            ...
            <ul class="list-unstyled">
              <li><a href="telephone-home"><i class="fas fa-mobile-alt"></i>Smartphone</a></li>
          ...
          <div class="col-lg-10 col-md-12">
            <div class="row">
              <?php
                 ...
                 foreach ($result as $row) {
              ?>
              <div id="show-product" class="col-lg-3 col-md-4 col-sm-6 mb-2 player <?php echo $row['brand']. ' '.$row['etat']; ?>">
                <div class="card-deck">
                  <form action="product-present-home.php" method="get">
                  <div class="card border-secondary">
                    <img src="upload/images/<?php echo $row["images"]; ?>" class="card-img-top">
                    <div class="card-body">
                       <h4 class="price-style"><?php echo $row["price"] . " DT"; ?></h4>
                       <p class="title-style"><?php echo $row["title"]; ?></p>
                       <p class="telephone-style"  style="font-weight: bold; color: #4d4d4d;"><i class="fas fa-phone-alt"></i><?php echo "+216".$row["telephonez"]; ?></p>
                       <p class="etat-style"><?php echo "Etat: ". $row["etat"]; ?></p>
